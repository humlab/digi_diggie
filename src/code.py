...
try:
    ...
    if pg_conn:
        ...
        try:
            # Check connection status if possible (varies by psycopg2 version)
        ...
        except AttributeError: # Older psycopg2 might not have status attribute easily checkable like this
