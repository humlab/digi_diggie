...
'==============================================================================
' DEPRECATED: This file has been split into two modules for better organization
'
' USE INSTEAD:
'   - minimal_app_generator.vba (form generation code)
'   - minimal_app_runtime.vba (event handlers for running forms)
'
' This file is kept for reference only. Do not use it in new projects.
'==============================================================================
